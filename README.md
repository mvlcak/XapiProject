...
7. In project\app\cron.py change endpoint in url https://watershedlrs.com/api/organizations/<yourLrsEndpoint>/query/export?type=json to  your endpoint from Watershed LRS
